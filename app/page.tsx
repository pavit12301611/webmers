...
export default async function Home() {
  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      {/* HERO 100vh dark/moody with spotlight - full spec */}
      <MeasuredHero />

      {/* Stats bar overlapping style - liquid glass */}
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            {stats.map((s) => (
              <div key={s.label} className="text-center md:text-left">
                <div
                  className="text-3xl font-[400] tracking-tight text-white md:text-5xl"
      ...
      {/* How it works - dark section with grid */}
      <section id="how" className="relative bg-[#0a0a0a] px-6 pb-24 pt-28 md:px-10">
        <div className="absolute inset-0 opacity-[0.04]">
          <svg width="100%" height="100%"><defs><pattern id="g1" width="48" height="48" patternUnits="userSpaceOnUse"><path d="M 48 0 L 0 0 0 48" fill="none" stroke="#64748b" strokeWidth="0.6" /></pattern></defs><rect width="100%" height="100%" fill="url(#g1)" /></svg>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-12 flex max-w-3xl flex-col gap-4">
            ...
            <h2
              className="text-balance text-4xl leading-[0.95] tracking-tight text-white md:text-6xl"
              style={{ fontFamily: "'Instrument Serif', serif" }}
            >
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {steps.map((item) => (
              <div
                key={item.step}
                className="group relative rounded-[1.6rem] border border-white/[0.07] bg-white/[0.02] p-7 backdrop-blur-xl transition hover:bg-white/[0.04] md:p-8"
              >
                <div className="mb-10 flex items-center justify-between">
                  <span
                    className="text-5xl text-white/[0.08] transition group-hover:text-white/[0.12]"
                    style={{ fontFamily: "'Instrument Serif', serif" }}
                  >
                    {item.step}
                  </span>
      ...
      {/* Featured - dark */}
      <section id="marketplace" className="relative bg-[#0a0a0a] px-6 py-24 md:px-10">
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-10 flex items-end justify-between gap-6">
            ...
            <Link
              href="/marketplace"
              className="hidden items-center gap-2 rounded-full border border-white/10 px-5 py-3 text-sm text-white/60 transition hover:border-white/20 hover:text-white md:inline-flex"
            >
      ...
      {/* Editor showcase */}
      <section className="relative bg-[#0a0a0a] px-6 py-24 md:px-10">
          ...
          <div>
            ...
            <ul className="mt-8 grid gap-3 text-sm text-white/50 sm:grid-cols-2">
              {['Inline text editing', 'Image swapping', 'Section rearranging', 'Colors and fonts', 'Version rollback', 'Instant publish'].map((f) => (
                <li
                  key={f}
                  className="flex items-center gap-3 rounded-full border border-white/[0.06] bg-white/[0.03] px-4 py-3"
                >
      ...
      {/* Categories - browse by habitat */}
      <section className="relative bg-[#f8f8f6] px-6 py-24 text-black md:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {categories.map((cat) => (
              ...
              >
                <h3
                  className="mb-1 text-xl tracking-tight md:text-2xl"
                  style={{ fontFamily: "'Instrument Serif', serif" }}
                >
                  {cat.name}
                </h3>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {benefits.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-[1.5rem] border border-white/[0.07] bg-white/[0.02] p-7 backdrop-blur-xl"
                >
      ...
      <section className="relative bg-[#0a0a0a] px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2
              className="mt-4 text-balance text-4xl leading-[0.95] tracking-tight text-white md:text-6xl"
              style={{ fontFamily: "'Instrument Serif', serif" }}
            >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {['Hero-Centered', 'Split-Screen', 'Video-Hero'].map((layout) => (
              <div
                key={layout}
                className="group relative aspect-[3/4] overflow-hidden rounded-[1.8rem] border border-white/10 bg-[#121212]"
              >
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-7">
                  <h3 className="text-2xl tracking-tight text-white" style={{ fontFamily: "'Instrument Serif', serif" }}>
                    {layout}
                  </h3>
      ...
      {/* Testimonials */}
      <section id="stories" className="relative bg-[#f8f8f6] px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <h2
            className="mb-10 text-4xl tracking-tight md:text-6xl"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              <div key={t.name} className="rounded-[1.8rem] border border-black/[0.06] bg-white p-8 shadow-[0_8px_40px_rgba(0,0,0,0.04)] md:p-10">
                ...
                <blockquote className="mb-7 text-balance text-xl font-[400] leading-snug md:text-2xl" style={{ fontFamily: "'Instrument Serif', serif" }}>
                  “{t.quote}”
                </blockquote>
      ...
      {/* Pricing */}
      <section id="pricing" className="relative bg-[#0a0a0a] px-6 py-24 text-center md:px-10">
        <div className="absolute inset-0 opacity-[0.04]"><svg width="100%" height="100%"><defs><pattern id="g2" width="48" height="48" patternUnits="userSpaceOnUse"><path d="M 48 0 L 0 0 0 48" fill="none" stroke="#64748b" strokeWidth="0.6" /></pattern></defs><rect width="100%" height="100%" fill="url(#g2)" /></svg></div>
        <div className="relative mx-auto max-w-5xl">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[11px] uppercase tracking-[0.18em] text-white/40">
            <Code2 size={12} /> Ownership
          </span>
          <h2
            className="mx-auto mt-4 max-w-3xl text-balance text-4xl leading-[0.95] tracking-tight text-white md:text-6xl"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
          ...
          <div className="mx-auto grid max-w-4xl gap-5 text-left md:grid-cols-2">
            <div className="rounded-[1.6rem] border border-white/[0.08] bg-white/[0.03] p-8 backdrop-blur-xl">
              ...
              <div className="mb-6 text-4xl text-white" style={{ fontFamily: "'Instrument Serif', serif" }}>Included</div>
            ...
            <div className="relative overflow-hidden rounded-[1.6rem] border border-white/[0.08] bg-white p-8 text-black">
              ...
              <div className="mb-6 text-4xl" style={{ fontFamily: "'Instrument Serif', serif" }}>$49 <span className="text-[14px] font-sans text-black/40">/ add-on</span></div>
      ...
      {/* Newsletter */}
      <section className="relative bg-[#0a0a0a] px-6 pb-24 md:px-10">
        <div className="mx-auto max-w-4xl rounded-[1.8rem] border border-white/[0.08] bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-8 text-center backdrop-blur-xl md:p-14">
          ...
          <h2 className="mt-4 text-3xl tracking-tight text-white md:text-5xl" style={{ fontFamily: "'Instrument Serif', serif" }}>
