  ...
  return (
    <main className="bg-background text-white px-6 md:px-10 py-28 md:py-36 flex items-center justify-center min-h-screen">
      <div className="text-center max-w-lg">
        ...
        <p className="text-[15px] leading-7 text-white/45 mb-8">You are now on the list. Weekly curated websites will arrive in your inbox. You can unsubscribe anytime.</p>
