    ...
    <main className="min-h-screen overflow-hidden bg-background">
      ...
      <section className="relative px-6 pb-20 pt-36 md:px-10">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-5 text-balance text-5xl leading-[0.95] tracking-tight text-foreground md:text-7xl" style={{ fontFamily: 'var(--font-instrument)' }}>
            Turn your websites <span className="text-foreground/40">into income.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-[16px] leading-8 text-foreground/45">
        ...
        <div className="relative mx-auto max-w-7xl">
          <Reveal>
            <div className="mb-12 max-w-2xl">
              ...
              <h2 className="mt-4 text-balance text-4xl leading-[0.95] tracking-tight text-foreground md:text-5xl" style={{ fontFamily: 'var(--font-instrument)' }}>
      ...
      <section className="relative px-6 pb-28 md:px-10">
        <Reveal>
          <div className="mx-auto max-w-4xl rounded-[1.8rem] border border-white/[0.08] bg-white/[0.04] p-10 text-center backdrop-blur-xl md:p-14">
            ...
            <p className="mx-auto mb-8 mt-4 max-w-xl text-foreground/40">
