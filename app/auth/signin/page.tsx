...
function SignInForm() {
  ...
  const [sandboxRole, setSandboxRole] = useState<'BUYER' | 'SELLER'>('BUYER');
        ...
        <form onSubmit={handleCredentials} className="mb-6 space-y-4">
          <div>
            ...
            <input
              ...
              autoComplete="email"
                  className="w-full rounded-full border border-white/10 bg-gradient-to-b from-[#fffdf9]/20 to-[#faf5ee]/10 px-5 py-3.5 text-foreground placeholder-foreground/30 outline-none backdrop-blur-xl shadow-[inset_0_2px_6px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.08)] transition-all focus:border-wander-orange/30 focus:shadow-[inset_0_2px_6px_rgba(0,0,0,0.04),0_0_0_3px_rgba(217,119,43,0.1),inset_0_1px_0_rgba(255,255,255,0.1)]"
                  required
                />
          </div>
          <div>
